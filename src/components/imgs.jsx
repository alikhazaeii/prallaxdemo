  ...
  return (
    <section className='w-full flex flex-wrap  '>
      ...
      <figcaption className=' w-full h-full'>
        <h3 className='group-hover:blur-0 blur-md absolute top-0 w-full left-0 text-center my-10 text-yellow-300'> Cassandre Beaugrand wears  </h3>
      ...
      <figcaption className=' w-full h-full'>
        <h3 className='group-hover:blur-0 blur-md absolute  top-0 left-0 w-full text-center my-10 text-yellow-300'> Kylian Mbappé wears </h3>
